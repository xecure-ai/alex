...
class AccountCreate(BaseModel):
    ...
    account_purpose: Optional[str] = Field(
        None,
        description="Purpose or goal of this account"
    )
...
class JobCreate(BaseModel):
    ...
    clerk_user_id: str = Field(
        description="User requesting this job"
    )
    job_type: JobType = Field(
        description="Type of analysis or operation to perform"
    )
...
class JobUpdate(BaseModel):
    ...
    result_payload: Optional[Dict] = Field(
        None,
        description="Results of the completed job"
    )
